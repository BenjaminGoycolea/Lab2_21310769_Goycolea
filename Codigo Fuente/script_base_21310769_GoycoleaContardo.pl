...
not(crearBiblioteca( [L1], [U1], [P1], -5, 30, 0.5, 1000, 40, F_INI, _)),
...
not(tomarPrestamo( B8, 2, 101, 2, F_3, _)),
write("Libro ocupado\n\n"),
% día 3
write("=== PROCESAR DÍA ===\n"),
...
not(tomarPrestamo( B13, 1, 102, 2, F_6, _)),
...
tomarPrestamo( B15, 1, 102, 3, F_6, _),
